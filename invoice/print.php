...
if ($res->num_rows > 0) {
  ...
  $obj = new NepaliCurrency($row["GRAND_TOTAL"]);
...
class PDF extends FPDF
{
  function Header()
  {
    ...
    $this->Cell(50, 10, "Manakamana Bag House", 0, 1);
    $this->SetFont('Arial', '', 12);
    $this->Cell(50, 7, "Sudurpaschim Province", 0, 1);
    $this->Cell(50, 7, "Dhangadhi-4, Kailali, Nepal.", 0, 1);
    $this->Cell(50, 7, "PH : 9865859728", 0, 1);

    //Display INVOICE text
    $this->SetY(15);
    $this->SetX(-40);
    $this->SetFont('Arial', 'B', 14);
    $this->Cell(50, 10, "Mero Byapar", 0, 1);
  ...
  function Footer()
  {
    ...
    $this->Cell(0, 10, "_________________", 0, 0.5, "R");
    $this->SetFont('Arial', '', 10);
